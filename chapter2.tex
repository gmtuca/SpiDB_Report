...
This is the only query supported by SpiDB with a variable number of returned packets. All other queries have at most one acknowledgement/return per incomming packet. 
